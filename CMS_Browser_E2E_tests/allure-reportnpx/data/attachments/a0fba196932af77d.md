...
Call log:
  - waiting for getByRole('button', { name: 'Add Customer' })

    at C:\Users\Daly\OneDrive - ESPRIT\Documents\Stage PFE\CMS_Browser_E2E_tests\tests\installer\installer-menutests.spec.ts:23:62
```
