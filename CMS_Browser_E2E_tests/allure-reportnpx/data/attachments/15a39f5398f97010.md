...
- Name: Installer Customers menu >> should edit a customer
- Location: C:\Users\Daly\OneDrive - ESPRIT\Documents\Stage PFE\CMS_Browser_E2E_tests\tests\installer\installer-menutests.spec.ts:31:7
...
Call log:
  - waiting for getByRole('button', { name: 'Edit' }).first()
    ...
    at C:\Users\Daly\OneDrive - ESPRIT\Documents\Stage PFE\CMS_Browser_E2E_tests\tests\installer\installer-menutests.spec.ts:34:62
```
